...
//IF EMAIL IS VALID THIS WILL BE THE FEEDBACK
        if (filter_var($user_email, FILTER_VALIDATE_EMAIL)) {

// CHECK IF EMAIL IS ALREADY REGISTERED AND GIVE THIS FEEDBACK
...
// IF EMAIL IS NOT REGISTERED DISPLAY THIS MESSAGE
                /* --

                ENCRYPT USER PASSWORD USING PHP password_hash function TO PREVENT HACKERSVG
